...
async def test_free_user_at_10_items_cannot_add_11th(client: AsyncClient, db_session: AsyncSession):
...
@pytest.mark.asyncio
@pytest.mark.usefixtures("_enable_monetization")
async def test_pro_user_can_exceed_10(client: AsyncClient, db_session: AsyncSession):
