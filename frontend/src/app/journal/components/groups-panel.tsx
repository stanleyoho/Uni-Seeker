...
// ---------------------------------------------------------------------------
// GroupsTabPanel — extracted from the former `/journal/groups` route.
//
// Mirrors the AccountsTabPanel sibling: the legacy `/journal/groups` route
// now permanent-redirects to `/journal?tab=groups`, where the parent
// `/journal/page.tsx` mounts this panel. AmbientBackground + page padding
