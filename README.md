...
| Financial Analysis | Phase 3 | Quarterly reports, ratios, health scoring (MOPS + SEC EDGAR) |
| Cash Flow Analysis | Phase 3 | FCF, cash conversion cycle, dividend coverage |
| Price Estimator | Phase 3 | PE/PB/DDM/DCF valuation models |
| Strategy | Phase 4 | Define entry/exit rules, position sizing, risk management |
...
| 財報分析 | Phase 3 | 季報解析、財務比率、健康度評分（公開資訊觀測站 + SEC EDGAR） |
| 現金流分析 | Phase 3 | 自由現金流、現金轉換週期、股利發放能力 |
| 股價預估 | Phase 3 | PE/PB/DDM/DCF 估值模型 |
| 投資策略 | Phase 4 | 定義進出場規則、部位管理、風控規則 |
